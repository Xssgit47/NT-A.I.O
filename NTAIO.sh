...
color="#00FFE2"<br>┏━━━━━━━━━━━━━━━┓<br>FNx 
DANGER<br>┗━━━━━━━━━━━━━━━┛<br></font><br><font 
color="#00FF00"></strong> <p style="text-align:center"><b> <br><font 
color="#00FFE2">D═══════D⊹⊱✫⊰⊹D═══════D</font><br><font 
color='#FFFF00'><b> ★ [ ༆Hʸᵖᵉʳ᭄W̺͆E̺͆L̺͆C̺͆O̺͆M̺͆E̺͆ T̺͆O̺͆ DANGER'S S̺͆E̺͆R̺͆V̺͆E̺͆R̺͆] ★ 
...
Hacking</font><br> <font color="#00FF00">❖Ƭʜᴇ No LODA-LASSAN</font><br> <font 
color="#00FF00">▄︻デDANGER DADDY IS HERE══━一 </font><br> <font 
color="#00FFE2">क═══════क⊹⊱✫⊰⊹क═══════क</font><br></font><br><font 
color="FFFF00">@FNxDANGER</font><br>
END
cd
chown -R www-data:www-data /home/vps/public_html
/etc/init.d/nginx restart
